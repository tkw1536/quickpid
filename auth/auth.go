...
type Authorization interface {
	// Level returns the level for the user associated with the given request and namespace.
	Level(logger *slog.Logger, r *http.Request, namespace string) (Level, error)
...
func (NoAuthentication) Level(l *slog.Logger, r *http.Request, namespace string) (Level, error) {
